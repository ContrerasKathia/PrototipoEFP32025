...
public class Login extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        cboModulos.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Seguridad", "Bancos", "Compras", "EXAMEN_FINAL" }));
            ...
            switch (areaSeleccionada) {
               ...
               /* case "Ventas":
                ...
                case "Bancos":
                    ...
                    case "EXAMEN_FINAL":
                    try {
                        MdiREPASO menuVentas = new MdiREPASO();
                        menuVentas.setVisible(true);
                        this.dispose();
                    } catch (Exception e) {
                        e.printStackTrace();
                        JOptionPane.showMessageDialog(this, "Error al abrir el módulo REPASO", "ERROR", JOptionPane.ERROR_MESSAGE);
                    }
                    break;
