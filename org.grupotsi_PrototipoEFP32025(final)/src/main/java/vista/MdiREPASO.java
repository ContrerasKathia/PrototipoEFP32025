 ...
 * @author visitante
 */
public class MdiREPASO extends javax.swing.JFrame {
    ...
    public MdiREPASO() {
        ...
        this.setExtendedState(MdiREPASO.MAXIMIZED_BOTH);
   ...
   //toma el usuario conectado (el que inicia sesion)
    ...
    private void AyudabtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_AyudabtnActionPerformed
        ...
        try {
            if ((new File("src\\main\\java\\ayudas\\ayudasComprasyCuentasPorPagar.chm")).exists()) {
                Process p = Runtime
                .getRuntime()
                .exec("rundll32 url.dll,FileProtocolHandler src\\main\\java\\ayudas\\AyudaVendedores.chm");
                p.waitFor();
            } else {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(MdiREPASO.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
